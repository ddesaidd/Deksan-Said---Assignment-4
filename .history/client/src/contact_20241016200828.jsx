...
//import '@mui/material @mui/styled-engine-sc styled-components';
//import '@mui/material @emotion/react @emotion/styled';
...
export default function Contact() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(submitForm)}>
      ...
      {/* Submit Button */}
      <button type="submit" variant="contained" color>Submit</button>
    </form>
    </>
  );
}
