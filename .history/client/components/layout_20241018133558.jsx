...
import { BrowserRouter as Router, Routes, Route, Link } from 'react-router-dom'; // No need for useNavigate or useLocation
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Box sx={{ width: 200, bgcolor: 'grey.200', p: 2 }}>
        ...
        <ul style={{ listStyle: 'none', padding: 0 }}>
          {navigation.map((item) => (
            <li key={item.segment}>
              <Link to={item.segment} style={{ textDecoration: 'none', color: 'blue' }}>
