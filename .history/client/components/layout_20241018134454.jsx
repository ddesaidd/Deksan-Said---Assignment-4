...
function App() {
  ...
  const theme = createTheme({
    palette: {
      ...
      background: {
        default: mode === 'light' ? '#f4f6f8' : '#121212', // Light/dark background for entire page
        paper: mode === 'light' ? '#ffffff' : '#333333', // Paper background for sidebar/content
      },
      text: {
        primary: mode === 'light' ? '#000000' : '#ffffff', // Text color for light/dark modes
      },
    },
  });

  // Apply the background color to the entire page (body)
  React.useEffect(() => {
